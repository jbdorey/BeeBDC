...
testData <- tibble::tribble(
  ~CodeBBdatabase_curated, ~'Scientific name corrected', ~Native.to.Brazil, ~Family_Proposed.in.Moure.Catalogue,      ~Family,   ~SubFamily,        ~Tribe,            ~Codigo, ~institutioncode, ~Day, ~Month, ~Year, ~Date_precision, ~Country,           ~State, ~Latitude_dec.degrees, ~Longitude_dec.degrees, ~Precision.of.coord.meters, ~NotasLatLong, ~NotesOnLocality,                     ~Locality.original, ~Spcslink.county, ~Spcslink.continentocean,               ~Collector, ~Collection,                                                                                                                                                                                     ~Source,         ~Sex,                                                                                                                                                                                    ~Project,        ~Det_By, ~Spcslink.linha_numero, ~Spcslink.datelastmodified, ~Spcslink.collectioncode, ~Spcslink.basisofrecord, ~Spcslink.identifiedby, ~Spcslink.yearidentified, ~Spcslink.barcode,
           ...
           "BBD_00082426",      "Secret species",             "yes",                            "Apidae", "Andrenidae", "Andreninae", "Calliopsini",                 NA,             "KU",   NA,    11L, 1939L,              NA, "Brazil",      "Sao Paulo",             -23.53377,              -46.69189,                         NA,            NA,               NA,                            "Sao Paulo",               NA,            "Neotropical",                "unknown",   "KU-SEMC",                                                                                                                                                             "SpeciesLink 22/12/2020 17:23h",           NA,                                                                                                                                                                                          NA,             NA,                270288L,                40933.39514,                 100623465863L,     "PreservedSpecimen",           "Ruz, Luisa",                       NA,                NA,
           "BBD_00082419",      "Secret species",             "yes",                            "Apidae", "Andrenidae", "Andreninae", "Calliopsini",                 NA,             "KU",  26L,     2L, 1954L,              NA, "Brazil", "Santa Catarina",           -27.1833333,            -52.3833333,                         NA,            NA,               NA,                        "Nova Teutonia",               NA,            "Neotropical",        "Plaumann, Fritz",   "KU-SEMC",                                                                                                                                                             "SpeciesLink 22/12/2020 17:23h",           NA,                                                                                                                                                                                          NA,             NA,                270340L,                40933.39375,                 1006265758L,     "PreservedSpecimen",                     NA,                       NA,                NA,
           ...
           "BBD_00082342",      "Secret species",             "yes",                            "Apidae", "Andrenidae", "Andreninae", "Calliopsini",                 NA,             "KU",   NA,    11L, 1951L,              NA, "Brazil", "Santa Catarina",           -27.1833333,            -52.3833333,                         NA,            NA,               NA,                        "Nova Teutonia",               NA,            "Neotropical",            "Plaumann, L",   "KU-SEMC",                                                                                                                                                             "SpeciesLink 22/12/2020 17:23h",           NA,                                                                                                                                                                                          NA,             NA,                270388L,                40933.39375,                 100245624566694L,     "PreservedSpecimen",                     NA,                       NA,                NA
  )
