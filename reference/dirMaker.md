...
#>  - We created the /tmp/RtmpOgSLRu/BDC_repo/BeeBDC/Rfile. This file needs to have the NewFunctions added to it otherise things won't work. These can be added from our GitHub
#>  - We created the /tmp/RtmpOgSLRu/Data_acquisition_workflowfile. This file needs to have the occurrence data that you want to use added to it otherise things won't work. Please choose this data or download it from the supp. materials of our paper
#> Warning: '/tmp/RtmpOgSLRu/BDC_repo/DiscoverLife_Data' already exists
#>  - We created the /tmp/RtmpOgSLRu/BDC_repo/DiscoverLife_Datafile. This file needs to have the DiscoverLife_Data added to it otherise things won't work. These can be added from our GitHub
#> Warning: '/tmp/RtmpOgSLRu/Data_acquisition_workflow/Output' already exists
#>  - We created the /tmp/RtmpOgSLRu/Data_acquisition_workflow/Outputfile.
#> <environment: 0x564f8df31000>
...
# Custom OutPathName provided
 ...
 useHere = FALSE) %>%
   # Add paths created by this function to the environment()
   list2env(envir = environment())  
#> Warning: '/tmp/RtmpOgSLRu/Data_acquisition_workflow/T2T_Output' already exists
#>  - We created the /tmp/RtmpOgSLRu/Data_acquisition_workflow/T2T_Outputfile.
#> <environment: 0x564f8dcc01f8>
...
#> Warning: '/tmp/RtmpOgSLRu/Data_acquisition_workflow/AsianPerspective_Output' already exists
#>  - We created the /tmp/RtmpOgSLRu/Data_acquisition_workflow/AsianPerspective_Outputfile.
#> <environment: 0x564f8dbd57f8>
