...
- printSummary:
  ...
  [`base::summary()`](https://rdrr.io/r/base/summary.html) of all filter
  columns - i.e. those which tidyselect::starts_with(".")
...
#>  - Data saved to /tmp/RtmpLF43mQ/flagsRecorded_2026-09-23.csv
