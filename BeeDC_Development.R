...
usethis::create_package(path = packageDir,
                        ...
                        fields = list(
                          ...
                          RoxygenNote = "7.2.1",
                          Depends = "R (>= 2.10)",
                          License = usethis::use_gpl3_license(version = 3, include_future = TRUE)
                        ))
  # Add required packages
requiredPackages <- sort(c("R.utils","bdc","tidyr","magrittr","dplyr","tibble","forcats",
                           "EML","emld", "stringr","lubridate","tidyselect","mgsub",
                           "rnaturalearth", "rnaturalearthdata", "ggplot2", "circlize", 
                           "readxl","readr","cowplot","igraph","ggspatial",  "rlist",
                           "CoordinateCleaner", "fs", "here", "sf", "paletteer",
                           "ComplexHeatmap", "vroom"))
...
suggestedPackages <- sort(c("praise", "rlang", "xml2",  "rvest", "countrycode", "rangeBuilder",
                            "rworldmap", "hexbin", "janitor",
                            "terra", "chorddiag", "rnaturalearthhires"))
