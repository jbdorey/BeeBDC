...
##  - There are also 175 complete year occurrences to filter from. This is up from an initial count of 174 At this rate, you will stand to lose 30 occurrences on the basis of missing year - Operation time: 0.59398889541626 secs
```
...
##  - Duplicates have been saved in the file and location: /tmp/RtmpwSXjvj/Data_acquisition_workflow/Output/ReportduplicateRun_collectionInfo_2026-01-15.csv
...
##  /tmp/RtmpwSXjvj/Data_acquisition_workflow/Output/Report/duplicateRun_collectionInfo_2026-01-15.csv
## Rows: 0 Columns: 19
