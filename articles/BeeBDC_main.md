...
##  - There are also 175 complete year occurrences to filter from. This is up from an initial count of 174 At this rate, you will stand to lose 30 occurrences on the basis of missing year - Operation time: 0.550607204437256 secs
```
...
##  - Duplicates have been saved in the file and location: /tmp/RtmpyHPbaA/Data_acquisition_workflow/Output/ReportduplicateRun_collectionInfo_2026-09-23.csv
...
##  /tmp/RtmpyHPbaA/Data_acquisition_workflow/Output/Report/duplicateRun_collectionInfo_2026-09-23.csv
## Rows: 0 Columns: 19
