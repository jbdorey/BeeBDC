...
##  - There are also 175 complete year occurrences to filter from. This is up from an initial count of 174 At this rate, you will stand to lose 30 occurrences on the basis of missing year - Operation time: 0.599916934967041 secs
```
...
##  - Duplicates have been saved in the file and location: /tmp/RtmpYlOn8e/Data_acquisition_workflow/Output/ReportduplicateRun_collectionInfo_2026-01-14.csv
...
##  /tmp/RtmpYlOn8e/Data_acquisition_workflow/Output/Report/duplicateRun_collectionInfo_2026-01-14.csv
## Rows: 0 Columns: 19
