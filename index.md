...
We provide a full workflow that uses **BeeBDC**, **bdc**, and
**CoordinateCleaner** to clean occurrence data in our Articles page and
encourage users to read and also cite this primary
...
functions*. The packages **BiocManager** and **devtools** may also be
required to download some extra packages.
...
2.  The package, **ComplexHeatmap**, is only used for one **BeeBDC**
    function
    ([`BeeBDC::chordDiagramR()`](https://jbdorey.github.io/BeeBDC/reference/chordDiagramR.md))
...
3.  The package **taxadb** is used by
    [`BeeBDC::taxadbToBeeBDC()`](https://jbdorey.github.io/BeeBDC/reference/taxadbToBeeBDC.md)
    to download and transform taxonomy files for **any taxon** and from
...
4.  The packages **iNEXT** and **SpadeR** can be downloaded in order to
    ...
    vignette). Implemented in the functions
...
- [`atlasDownloader()`](https://jbdorey.github.io/BeeBDC/reference/atlasDownloader.md)
  Downloads ALA data and creates a new file in the path to put those
  data. This function can also request downloads from other atlases
  ([see
...
- [`repoMerge()`](https://jbdorey.github.io/BeeBDC/reference/repoMerge.md)
  ...
  reads it in along with its eml metadata.
- [`repoFinder()`](https://jbdorey.github.io/BeeBDC/reference/repoFinder.md)
  Find GBIF, ALA, iDigBio, and SCAN files in a directory.
- [`importOccurrences()`](https://jbdorey.github.io/BeeBDC/reference/importOccurrences.md)
...
- [`USGS_formatter()`](https://jbdorey.github.io/BeeBDC/reference/USGS_formatter.md)
  The function finds, imports, formats, and creates metadata for the
  USGS dataset.
- [`formattedCombiner()`](https://jbdorey.github.io/BeeBDC/reference/formattedCombiner.md)
...
- [`dataSaver()`](https://jbdorey.github.io/BeeBDC/reference/dataSaver.md)
...
- [`PaigeIntegrater()`](https://jbdorey.github.io/BeeBDC/reference/PaigeIntegrater.md)
  ...
  . . . McCabe, L. M. (In Press). Completeness analysis for over 3000
  United States bee species identifies persistent data gaps. Ecography.
- [`readr_BeeBDC()`](https://jbdorey.github.io/BeeBDC/reference/readr_BeeBDC.md)
  ...
  data providers. There is an internal readr function for each dataset
  and each one of these functions is called by readr_BeeBDC. While these
...
- [`idMatchR()`](https://jbdorey.github.io/BeeBDC/reference/idMatchR.md)
  This function attempts to match database_ids from a prior **bdc** or
  **BeeBDC** run in order to keep this column somewhat consistent
...
- [`countryNameCleanR()`](https://jbdorey.github.io/BeeBDC/reference/countryNameCleanR.md)
  This is a basic function for a user to manually fix some country name
  inconsistencies.
- [`jbd_CfC_chunker()`](https://jbdorey.github.io/BeeBDC/reference/jbd_CfC_chunker.md)
  Because the `BeeBDC::jbd_country_from_coordinates()` function is very
...
- [`jbd_Ctrans_chunker()`](https://jbdorey.github.io/BeeBDC/reference/jbd_Ctrans_chunker.md)
  Because the
  [`BeeBDC::jbd_coordinates_transposed()`](https://jbdorey.github.io/BeeBDC/reference/jbd_coordinates_transposed.md)
...
- [`jbd_coordCountryInconsistent()`](https://jbdorey.github.io/BeeBDC/reference/jbd_coordCountryInconsistent.md)
  ...
  This functions will preferably use the countryCode and
  country_suggested columns generated by
  [`bdc::bdc_country_standardized()`](https://brunobrr.github.io/bdc/reference/bdc_country_standardized.html);
...
- [`flagRecorder()`](https://jbdorey.github.io/BeeBDC/reference/flagRecorder.md)
  This function is used to save the flag data for your occurrence data
  as you run the **BeeBDC** script. It will read and append existing
  files, if asked to. Your flags should also be saved in the occurrence
...
**taxadb**, from the provided Discover Life,
`https://www.discoverlife.org`, website’s taxonomic reference, or a
custom taxonomy.

- [`taxadbToBeeBDC()`](https://jbdorey.github.io/BeeBDC/reference/taxadbToBeeBDC.md)
  Uses the **taxadb** to download a species taxonomy from any of their
  sources and transforms it into the **BeeBDC** format that can then be
  exported as a .csv or into the **R** environment to be be fed directly
  into
  [`BeeBDC::harmoniseR()`](https://jbdorey.github.io/BeeBDC/reference/harmoniseR.md).
  This means that the taxonomy from ANY taxon can be used. See also
...
- [`harmoniseR()`](https://jbdorey.github.io/BeeBDC/reference/harmoniseR.md)
  ...
  those that do not match the checklist. This function could be hijacked
  to service other taxa if a user matched the format of the beesTaxonomy
  file.
  [`BeeBDC::harmoniseR()`](https://jbdorey.github.io/BeeBDC/reference/harmoniseR.md)
  prefers to use the names_clean columns that is generated by
...
- [`jbd_coordinates_precision()`](https://jbdorey.github.io/BeeBDC/reference/jbd_coordinates_precision.md)
  This function flags occurrences where BOTH latitude and longitude
  values are rounded. This contrasts with the original function,
  [`bdc::bdc_coordinates_precision()`](https://brunobrr.github.io/bdc/reference/bdc_coordinates_precision.html)
  that will flag occurrences where only one of latitude OR longitude are
  rounded. The **BeeBDC** approach saves occurrences that may have had
  terminal zeros rounded in one coordinate column.
- [`diagonAlley()`](https://jbdorey.github.io/BeeBDC/reference/diagonAlley.md)
  ...
  fill-down errors by identifying consecutive occurrences with
  coordinates at regular intervals. This is accomplished by using a
...
- [`coordUncerFlagR()`](https://jbdorey.github.io/BeeBDC/reference/coordUncerFlagR.md)
  ...
  “coordinateUncertaintyInMeters” and a threshold above which
...
- [`countryOutlieRs()`](https://jbdorey.github.io/BeeBDC/reference/countryOutlieRs.md)
  This function flags country-level outliers using the checklist
  provided with this package. For additional context and column names,
  see `beesChecklist`.
- [`continentOutlieRs()`](https://jbdorey.github.io/BeeBDC/reference/continentOutlieRs.md)
  ...
  provided with this package. This function works much the same as
  [`countryOutlieRs()`](https://jbdorey.github.io/BeeBDC/reference/countryOutlieRs.md),
  but at a lower resolution. For additional context and column names,
  see `beesChecklist`.
- [`jbd_create_figures()`](https://jbdorey.github.io/BeeBDC/reference/jbd_create_figures.md)
  Creates figures (i.e., bar plots, maps, and histograms) reporting the
  results of data quality tests implemented the bdc and **BeeBDC**
  packages. Works like
...
- [`dupeSummary()`](https://jbdorey.github.io/BeeBDC/reference/dupeSummary.md)
  ...
  duplicate occurrence records. Duplicates are identified iteratively
  and will be tallied up, duplicate pairs clustered, and sorted at the
  end of the function. The function is designed to work with Darwin Core
  data with a database_id column, but it is also modifiable to work with
  other columns.
...
- [`manualOutlierFindeR()`](https://jbdorey.github.io/BeeBDC/reference/manualOutlierFindeR.md)
  ...
  to identify duplicates of the expert-identified outliers and flag
  those as well. The function will add a flagging column called
  .expertOutlier where records that are FALSE are the expert outliers.
- [`summaryFun()`](https://jbdorey.github.io/BeeBDC/reference/summaryFun.md)
  ...
  after creating the .summary column. Additionally, the occurrence
  dataset can be filtered to only those where .summary = TRUE at the end
  of the function.
...
- [`dupePlotR()`](https://jbdorey.github.io/BeeBDC/reference/dupePlotR.md)
  ...
  This function requires a dataset that has been run through
  [`BeeBDC::dupeSummary()`](https://jbdorey.github.io/BeeBDC/reference/dupeSummary.md).
...
- [`summaryMaps()`](https://jbdorey.github.io/BeeBDC/reference/summaryMaps.md)
  Builds an output figure that shows the number of species and the
  number of occurrences per country. Breaks the data into classes for
  visualisation. Users may filter data to their taxa of interest to
  produce figures of interest.
- [`interactiveMapR()`](https://jbdorey.github.io/BeeBDC/reference/interactiveMapR.md)
  Uses the occurrence data (preferably uncleaned) and outputs
  interactive .html maps that can be opened in your browser to a
  specific directory. The maps can highlight if an occurrence has passed
  all filtering (.summary == TRUE) or failed at least one filter
  ...
  highlight occurrences flagged as expert-identified or country
  outliers.
- [`dataProvTables()`](https://jbdorey.github.io/BeeBDC/reference/dataProvTables.md)
  ...
  columns to find data providers using a an internally set sequence of
  if-else statements. Hence, this function is quite specific for bee
  data, but should work for other taxa in similar institutions.
- [`flagSummaryTable()`](https://jbdorey.github.io/BeeBDC/reference/flagSummaryTable.md)
  ...
  the scientificName column, users may select any grouping column (e.g.,
  country).
...
- `diversityPrepR()` Takes your occurrence dataset along with a taxonomy
  ...
  into the
  [`BeeBDC::richnessEstimateR()`](https://jbdorey.github.io/BeeBDC/reference/richnessEstimateR.md)
  function in order to estimate species richness using iChao
  (non-parametric species richness;
  [`BeeBDC::ChaoWrapper()`](https://jbdorey.github.io/BeeBDC/reference/ChaoWrapper.md))
  and iNEXT (hill numbers;
  [`BeeBDC::iNEXTwrapper()`](https://jbdorey.github.io/BeeBDC/reference/iNEXTwrapper.md))
  for countries, continents, or the entire globe.
- [`richnessEstimateR()`](https://jbdorey.github.io/BeeBDC/reference/richnessEstimateR.md)
  Takes an output dataset from `BeeBDC::diversityPrepR()` to estimate
  species richness using iChao (non-parametric species richness;
  [`BeeBDC::ChaoWrapper()`](https://jbdorey.github.io/BeeBDC/reference/ChaoWrapper.md))
  and iNEXT (hill numbers;
  [`BeeBDC::iNEXTwrapper()`](https://jbdorey.github.io/BeeBDC/reference/iNEXTwrapper.md))
  for countries, continents, and/or the entire globe. Has parallel
  functionality.
- [`iNEXTwrapper()`](https://jbdorey.github.io/BeeBDC/reference/iNEXTwrapper.md)
  A wrapper for
  [`iNEXT::iNEXT()`](https://rdrr.io/pkg/iNEXT/man/iNEXT.html) to
  interpolate and extrapolate Hill numbers with order q (rarify species
  richness). The wrapper has the ability to estimate species richness
  for multiple sites (or countries) at once and to do this using
  multiple cores.
- [`ChaoWrapper()`](https://jbdorey.github.io/BeeBDC/reference/ChaoWrapper.md)
  ...
  to non-parametrically estimate species richness. The wrapper has the
...
- [`beesTaxonomy()`](https://jbdorey.github.io/BeeBDC/reference/beesTaxonomy.md)
  Downloads the taxonomic information for the bees of the world. Source
  of taxonomy is listed under “source” but are mostly derived from the
  Discover Life website. The data will be sourced from the **BeeBDC**
  article’s Figshare. Please see also
  [`BeeBDC::taxadbToBeeBDC()`](https://jbdorey.github.io/BeeBDC/reference/taxadbToBeeBDC.md)
  for the download of any other taxonomy (for any taxa or for bees).
- [`beesChecklist()`](https://jbdorey.github.io/BeeBDC/reference/beesChecklist.md)
  Download the table contains taxonomic and country information for the
  bees of the world based on data collated on Discover Life. The data
  will be sourced from the **BeeBDC** article’s Figshare.

We further provide five test datasets that are available with
**BeeBDC**.

- [`BeeBDC::bees3sp`](https://jbdorey.github.io/BeeBDC/reference/bees3sp.md)
  This test dataset includes 105 random occurrence records from three
  bee species. The included species are: “*Agapostemon tyleri*
  Cockerell, 1917”, “*Centris rhodopus* Cockerell, 1897”, and “*Perdita
  octomaculata* (Say, 1824)”.
- [`BeeBDC::beesRaw`](https://jbdorey.github.io/BeeBDC/reference/beesRaw.md)
  A small bee occurrence dataset with flags generated by **BeeBDC** used
  to run example script and test functions. For data types, see
  [`ColTypeR()`](https://jbdorey.github.io/BeeBDC/reference/ColTypeR.md).
- [`BeeBDC::beesFlagged`](https://jbdorey.github.io/BeeBDC/reference/beesFlagged.md)
  ...
  [`ColTypeR()`](https://jbdorey.github.io/BeeBDC/reference/ColTypeR.md).
- [`BeeBDC::beesCountrySubset`](https://jbdorey.github.io/BeeBDC/reference/beesCountrySubset.md)
  A very small bee occurrence dataset with the columns “scientificName”
  and “country_suggested” and data for four countries, Fiji, Uganda,
  Vietnam, and Zambia. This is the test dataset for the species richness
  functions.
...
- **Species richness estimation citation:** Dorey J. B., Gilpin, A.-M.,
  ...
  (2026). Estimating global bee species richness and taxonomic gaps.
  *Nature Communications*. <https://doi.org/10.1038/s41467-026-69029-4>
- **BeeBDC package citation:** Dorey, J. B., O’Reilly, R. L.,
  Bossert, S. & Fischer, E. (2023). **BeeBDC**: an occurrence data
  cleaning package. R package version 1.3.4. url:
  <https://github.com/jbdorey/BeeBDC>
...
[![The iDigBees logo with a colourful bee and the iDigBees text on the
right](https://photos.smugmug.com/photos/i-rcd8CCs/0/b291edd1/O/i-rcd8CCs.png)](https://idigbees.org)
