# Description of the BeeDC toy dataset beesRaw.csv written by James B. Dorey on the 
# 16th of March 2023
...
#' }
#' @references This data set was created by generating a random subset of 100 rows from the full, unfiltered and unflagged, BeeDC dataset from the publication:
