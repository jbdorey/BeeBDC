# Description of the BeeDC toy dataset beesFlagged.csv written by James B. Dorey on the 
# 16th of March 2023
...
#' }
#' @references This data set was created by generating a random subset of 100 rows from the full BeeDC dataset from the publication:
