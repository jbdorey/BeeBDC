...
#'
#' Contains taxonomic and country information for the bees of the world. See [BeeDC::beesTaxonomy()]
#'  for further context
#'
#' @docType data
#'
#' @usage BeeDC::beesChecklist
#'
#' @format An object of class \code{"tibble"}
#' \describe{
#'  \item{validName}{The valid scientificName as it should occur in the scientificName column.}
#'  \item{ISO}{The ISO names as it occurs on Discover Life.}
#'  \item{Long_country_name}{The country names as it occurs on Discover Life.}
#'  \item{Country_name}{A short country name version.}
#'  \item{Alpha-2}{Alpha-2 from rnaturalearth.}
#'  \item{Alpha-3}{Alpha-3 from rnaturalearth.}
#'  \item{ISO.y}{entry}
#'  \item{database_id}{Another format of Alpha-3.}
#'  \item{official}{Official country name "yes" or Discover Life name "no"}
...
#'  \item{Freq}{The count of unique species names per country.}
#'  \item{matchName}{A simplified validName/scientificName for matching.}
#'  \item{accid}{The accepted taxon id according to beesTaxonomy. For accepted taxa, accid == 0.}
#'  \item{id}{The id number for the name in beesTaxonomy.}
#'  \item{family}{Bee family.}
#'  \item{subfamily}{Bee subfamily.}
#'  \item{validName_taxonomy}{The validName from the beesTaxonomy}
#'  \item{canonical}{The validName without the scientificNameAuthority.}
...
#'  \item{matchCertainty}{Quality of the name match to the Discover Life checklist.}
#'  \item{sciName_country}{A simplified merger of validName and country for matching.}
#'  
#' }
#' @references This dataset was created using the Discover Life checklist and taxonomy. See rawDataWrite.R
