...
```{r rnaturalearthhires, include=FALSE}
devtools::install_github("ropensci/rnaturalearthhires")
...
This step identifies mismatches between the [Discover Life](http://discoverlife.org) country checklist — `beesChecklist` — for bee species and the dataset, identifying potential misidentifications, outliers, etc.’ 
