...
```{r installPackages, message=FALSE, warning=FALSE, results=FALSE, collapse = TRUE}
...
```{r installBeeBDC, results=TRUE, message=TRUE, eval = TRUE, collapse = TRUE}
...
```{r 6.0ii, collapse = TRUE, data-background=#ff0000}
