...
To start out, you will need to install BiocManager, devtools, **ComplexHeatmap**, and **rnaturalearthhires** to then install adn fully use BeeBDC.
```{r installPackages, results=FALSE}
...
![Full chord diagram from Dorey et al. 2023](https://github.com/jbdorey/BeeBDC/blob/main/inst/extdata/icon_vignettes/ChordDiagram.pdf)
